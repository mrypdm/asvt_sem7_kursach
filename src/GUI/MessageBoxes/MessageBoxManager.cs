...
{
    /// <inheritdoc />
    public async Task<ButtonResult> ShowMessageBoxAsync(string title, string text, ButtonEnum buttons, Icon icon,
        Window owner)
    {
    ...
    /// <inheritdoc />
    public async Task<string> ShowCustomMessageBoxAsync(string title, string text, Icon icon, Window owner,
    ...
    /// <inheritdoc />
    public async Task<(ButtonResult, string)> ShowInputMessageBoxAsync(string title, string text,
        ButtonEnum buttons,
        Icon icon,
    ...
    /// <inheritdoc />
    public Task ShowErrorMessageBox(string message, Window owner) =>
