...
internal record Instruction
{
    public static readonly Dictionary<string, Instruction> Instructions = new Instruction[]
    {
        ...
        new("fadd", 0b0_111_101_000_000_000, 1),
        new("sub", 0b1_110_000_000_000_000, 2),
        new("fsub", 0b0_111_101_000_001_000, 1),
        ...
        new("mul", 0b0_111_000_000_000_000, 2),
        new("fmul", 0b0_111_101_000_010_000, 1),
        new("div", 0b0_111_001_000_000_000, 2),
        new("fdiv", 0b0_111_101_000_011_000, 1),
        new("ash", 0b0_111_010_000_000_000, 2),
        new("ashc", 0b0_111_011_000_000_000, 2),
        ...
        new("emt", 0b1_000_100_000_000_000, 1),
        new("trap", 0b1_000_100_100_000_000, 1),
        ...
        new("clc", 0b0_000_000_010_100_001, 0),
        new("clv", 0b0_000_000_010_100_010, 0),
        new("clz", 0b0_000_000_010_100_100, 0),
        new("cln", 0b0_000_000_010_101_000, 0),
        new("sec", 0b0_000_000_010_110_001, 0),
        new("sev", 0b0_000_000_010_110_010, 0),
        new("sez", 0b0_000_000_010_110_100, 0),
        new("sen", 0b0_000_000_010_111_000, 0),
        new("scc", 0b0_000_000_010_111_111, 0),
        new("ccc", 0b0_000_000_010_101_111, 0),
        new("nop", 0b0_000_000_010_100_000, 0),
        // Pseudo instructions
        new(".word", 0, -1),
        new(".blkw", 0, 1),
        new(".end", 0, 1)
